      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 pb-10 border-b border-white/10 mb-12">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <a href="mailto:akkigupta2411@gmail.com" className="text-white hover:text-[#8CFF64] transition-colors text-sm lg:text-base font-semibold">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <a href="https://wa.me/916200065378" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#8CFF64] transition-colors text-sm lg:text-base font-semibold uppercase">
              live chat
            </a>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
            ...
            <div className="space-y-4 text-xs lg:text-sm text-white/60 leading-relaxed">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <a href="tel:6200065378" className="hover:text-[#8CFF64] font-bold">6200065378</a>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-2.5 text-xs lg:text-sm text-white/60 font-medium">
              ...
              <li>
                <Link to="/terms-conditions" className="hover:text-[#8CFF64] transition-colors">Terms & Conditions</Link>
              </li>
              <li>
                <Link to="/shipping-delivery" className="hover:text-[#8CFF64] transition-colors">Shipping & Delivery</Link>
              </li>
              <li>
                <Link to="/exchange-policy" className="hover:text-[#8CFF64] transition-colors">Exchange Policy</Link>
              </li>
            </ul>
          </div>
